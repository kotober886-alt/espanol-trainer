(function(){
  ...
  window.foodArt=function(kind){return sprite("foods",kind,7,5);};
  window.clothingArt=function(kind){return sprite("clothes",kind,6,5);};
  window.activityArt=function(kind){return sprite("activities",kind,7,6);};
})();
