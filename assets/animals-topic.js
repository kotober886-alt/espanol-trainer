(function(){
'use strict';
const IMG='assets/picture-labels/study-animals-v5.webp';
...
try{if(typeof TOPICS!=='undefined'&&!TOPICS.some(t=>t.id==='animals')){const i=TOPICS.findIndex(t=>t.id==='custom');TOPICS.splice(i<0?TOPICS.length:i,0,{id:'animals',title:'Животные',icon:'🐾'});}}catch(e){}
try{if(typeof TOPIC_GROUPS!=='undefined'){const g=TOPIC_GROUPS.find(x=>x.title==='Повседневная жизнь');if(g&&g.ids.indexOf('animals')<0)g.ids.push('animals');}}catch(e){}
try{if(typeof allExercises==='function'){const b=allExercises;allExercises=function(){return b().concat(EX);};}}catch(e){}
try{if(typeof vocabularyWords==='function'){const b=vocabularyWords;vocabularyWords=function(){return selectedTopic==='animals'?WORDS:b();};}}catch(e){}
try{if(typeof studyVocabularyWords==='function'){const b=studyVocabularyWords;studyVocabularyWords=function(){return selectedTopic==='animals'?WORDS:b();};}}catch(e){}
try{if(typeof categoriesForTopic==='function'){const b=categoriesForTopic;categoriesForTopic=function(t){return t==='animals'?CATS:b(t);};}}catch(e){}
try{if(typeof studyArt==='function'){const b=studyArt;studyArt=function(w){return selectedTopic==='animals'?art(w.art):b(w);};}}catch(e){}
try{if(typeof studyTitle==='function'){const b=studyTitle;studyTitle=function(){return selectedTopic==='animals'?'Сначала познакомимся с животными':b();};}}catch(e){}
try{if(typeof studyIntro==='function'){const b=studyIntro;studyIntro=function(){return selectedTopic==='animals'?'Учи животных по группам: домашние, ферма, дикие, птицы, морские, рептилии и амфибии. На каждой карточке есть иллюстрация и живые примеры.':b();};}}catch(e){}
try{if(typeof studyUnitLabel==='function'){const b=studyUnitLabel;studyUnitLabel=function(){return selectedTopic==='animals'?'Животное':b();};}}catch(e){}
try{if(typeof renderStudy==='function'){const b=renderStudy;renderStudy=function(){b();if(selectedTopic==='animals'&&els&&els.studyCard)els.studyCard.classList.remove('no-art');};}}catch(e){}
try{if(typeof renderTopics==='function'){const b=renderTopics;renderTopics=function(){b();const x=document.querySelector('[data-topic="animals"] .topic-count');if(x)x.textContent=WORDS.length+' слов';};}}catch(e){}
try{if(typeof els!=='undefined'&&els.customTopic&&!els.customTopic.querySelector('option[value="animals"]')){const o=document.createElement('option');o.value='animals';o.textContent='Животные';els.customTopic.insertBefore(o,els.customTopic.querySelector('option[value="custom"]'));}}catch(e){}
const st=document.createElement('style');st.textContent='.generated-sprite-animals{background-repeat:no-repeat;background-color:#faf9f6}.study-card:not(.no-art) .generated-sprite-animals{width:min(100%,420px);aspect-ratio:1/1}';document.head.appendChild(st);
