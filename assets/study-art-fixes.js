(function(){
  ...
  try { remap(FOOD_WORDS,{mussels:'mussels',octopus:'octopus',seafood:'seafood',wine:'wine',beer:'beer',juice:'juice',lemonade:'lemonade',soda:'soda',hotchocolate:'hotchocolate',muffin:'muffin',flan:'flan',candy:'candy',puree:'puree'}); } catch(e){}
