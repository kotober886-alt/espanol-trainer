(function(){
  ...
  const custom={
    ...
    shrimp:svg('<path fill="'+C.pink+'" d="M47 67c22-34 67-39 90-12 19 23 10 58-16 73-23 13-53 10-69-8-13-15-15-35-5-53Z"/><path fill="'+C.cream+'" d="M72 72c14-12 34-13 48-1 11 9 13 23 7 34-7 13-24 20-39 16 17-8 24-22 20-34-4-11-17-17-36-15Z"/><circle cx="56" cy="72" r="5" fill="'+C.ink+'"/>'),
  ...
  try { remap(FOOD_WORDS,{shrimp:'shrimp',mussels:'mussels',squid:'squid',octopus:'octopus',seafood:'seafood',wine:'wine',beer:'beer',juice:'juice',lemonade:'lemonade',soda:'soda',hotchocolate:'hotchocolate',muffin:'muffin',flan:'flan',candy:'candy',puree:'puree'}); } catch(e){}
